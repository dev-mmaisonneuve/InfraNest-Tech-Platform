      ...
      <div className="container stack">
        ...
        <div>
          <SectionHeading
            ...
            description="The goal is not more noise — it is a cleaner operating environment, steadier support, and better decisions around the systems your business depends on."
          />
